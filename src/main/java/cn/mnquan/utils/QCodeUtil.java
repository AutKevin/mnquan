...
public class QCodeUtil {
    ...
    public static void main(String[] args){
        File logoFile = new File("F://tbk/picture/appStore.png");
        File QrCodeFile = new File("F://tbk/picture/qcodeCeshi.png");
        String url = "http://192.168.1.108:8080/app/apk/download.do";
        String note = "";
