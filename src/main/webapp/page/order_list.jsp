...
<div class="order-nav" style="position: relative; top: 0px; margin-top: 0px;">
    <ul>
        <li class="cur">
            <span><a data-sort="shop_dsr" class="" href="javascript:void(0);" key="desc">全部</a></span>
        </li>
        <li class="">
            <span><a data-sort="latest" href="javascript:void(0);" class="theme-color-1" key="desc">待结算</a></span>
        </li>
        <li class="">
            <span><a data-sort="volume" href="javascript:void(0);" key="desc">已结算</a></span>
        </li>
        <li class="">
            <span><a data-sort="zk_final_price" href="javascript:void(0);" key="desc">已退款</a></span>
        </li>
    </ul>
</div>
...
<script>
    ...
    $(".order-nav li").on("click",function(){
        ...
        if($(this).index()==$(".order-nav li").length-1){
            var key = $(this).attr("key") == "asc" ? "desc" : 'asc';
            if(key != "asc"){
        ...
        px = $(this).find("a").attr("data-sort")+" "+$(this).find("a").attr("key");
        get_list(px);
    });
    ...
    function get_list(sort){
        $.ajax({
            ...
            async:false,
            data: {'pageNo':pageNo,'levelOneCategoryId':catId,'categoryId':categoryId,'sort':sort},
            dataType:'json',
            type:"post",
