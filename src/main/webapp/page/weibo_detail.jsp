...
<div class="goods_shop_cart" ui-footprint data-item='goodsItem' data-type="1" >
    <div class="cent row-s">
       ...
       <%-- <div class="col-12-2 text-center but" style=" position: none; left: -.7rem;">
        ...
        <!-- 领券购买 淘口令 -->
        <div class="col-12-8" style="margin-left: 15%;">
            <div class="btn btn-primary btn-block row-s">
                <a href="javascript:;" id="share_token" name="${optionalDo.token}" class="col-12-5 active">分享</a>
                <a href="javascript:;" id="token_buy_01" name="${optionalDo.token}" class="col-12-7 getGoodsLink">口令购买</a>
            </div>
        </div>
    </div>
...
<div class="layout row" id="anchors_info" ui-up-app data-location="top" data-top="">
    ...
    <div class="goods_info">
        ...
        <div class="goods_quan row-s">
            <!--  -->
            <a class="row getGoodsLink" ui-open-taobao  id="token_buy_02" href="javascript:;" >
        ...
        <div class="goods_desc col-mar col-888">${optionalDo.jddPrice}</div>
    </div>
    <div class="hr"></div>
...
<style>
    ...
    .top-dow .top-dow-header{
        background-image: url(/page/img/close-01.png);
        position: absolute;
        right: 50px;
        width: 23px;
        height: 21px;
    ...
    .top-dow .top-dow-footer{
        margin-top: 3%
    }
    .top-dow .top-dow-footer .top-dow-a {
        text-align: center;
        width: 36%;
        line-height: 20px;
...
<div class="top-dow">
    ...
    <p class="top-dow-p">天猫淘宝，超级优惠券中心。</p>
</div>
<script>
...
<script>
    ...
    $(".top-dow-header").click(function () {
        $(".top-dow").css("display","none");
    });

    $("#token_buy_01").click(function () {
        $(".t_token").css("display","inline");
    });
    $(".modal-header").click(function () {
        $(".t_token").css("display","none");
    });
    $("#token_buy_02").click(function () {
        $(".t_token").css("display","inline");
    });
    $(".modal-header").click(function () {
        $(".t_token").css("display","none");
