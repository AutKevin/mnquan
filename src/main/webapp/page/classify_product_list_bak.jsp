...
<div class="order-nav order-nav-cat" style="position: relative; top: 0px; margin-top: 0px;">
    <ul>
        <li class="">
            <span><a data-sort="t" class="" href="javascript:void(0);">人气</a></span>
        </li>
        <li class="theme-border-bottom-color-1 cur">
            <span><a data-sort="latest" href="javascript:void(0);" class="theme-color-1">最新</a></span>
        </li>
        <li class="">
            <span><a data-sort="sell" href="javascript:void(0);">销量</a></span>
        </li>
        <li class="">
            <%--<span>
                <a data-sort="price" href="javascript:void(0);">价格
